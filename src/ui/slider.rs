...
impl Slider {
    pub fn new(
        bounds: Rect,
        initial: f32,
        on_change: impl FnMut(f32) -> EventResponse + 'static,
    ) -> Self {
        Self {
            bounds,
    ...
    fn track_rect(&self) -> Rect {
        ...
        Rect {
            x: self.bounds.x + theme::SLIDER_THUMB_R,
            y,
            width: self.bounds.width - theme::SLIDER_THUMB_R * 2.0,
            height: theme::SLIDER_TRACK_H,
        }
    }
...
impl Widget for Slider {
    ...
    fn render_quads(&self) -> Vec<QuadInstance> {
        ...
        let thumb_color = if self.dragging {
            theme::SLIDER_THUMB_PRESS
        } else if self.hovered {
            theme::SLIDER_THUMB_HOVER
        } else {
            theme::SLIDER_THUMB_NORMAL
        };
        ...
        vec![
            QuadInstance {
                ...
                color: theme::SLIDER_TRACK_BG,
                color_bottom: theme::SLIDER_TRACK_BG,
                border_color: [0.0; 4],
                border_width: 0.0,
                border_radius: 2.0,
                shadow_offset: [0.0; 2],
            ...
            QuadInstance {
                ...
                color: theme::SLIDER_TRACK_FILL,
                color_bottom: theme::SLIDER_TRACK_FILL,
                border_color: [0.0; 4],
                border_width: 0.0,
                border_radius: 2.0,
                shadow_offset: [0.0; 2],
            ...
            QuadInstance {
                // Thumb
                rect: [
                    cx - theme::SLIDER_THUMB_R,
                    self.bounds.y + self.bounds.height / 2.0 - theme::SLIDER_THUMB_R,
                    theme::SLIDER_THUMB_R * 2.0,
                    theme::SLIDER_THUMB_R * 2.0,
                ],
                color: thumb_color,
                color_bottom: thumb_color,
                border_color: [0.0; 4],
                border_width: 0.0,
                border_radius: theme::SLIDER_THUMB_R,
