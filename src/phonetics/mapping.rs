...
pub enum MappingError {
    EmptySequence,
    ConflictingPriorities { a: String, b: String },
    /// A declared phoneme has no rule and is not explicitly silenced.
    UnmappedPhoneme { phoneme: Phoneme, language: Language },
}
...
pub fn relevant_phonemes(language: Language) -> &'static [Phoneme] {
    ...
    match language {
        Language::French => &[
            OpenCentral, OpenBackFr, CloseFront, CloseMidFront, OpenMidFront,
            CloseMidBackRounded, OpenMidBackRounded, CloseBackRounded, CloseFrontRounded,
            CloseMidFrontRounded, OpenMidFrontRounded, Schwa,
            NasalOpenBackFr, NasalOpenMidFrontFr, NasalOpenMidBackFr, NasalOpenMidFrontRoundedFr,
            VoicelessBilabialPlosive, VoicedBilabialPlosive, VoicelessAlveolarPlosive,
            VoicedAlveolarPlosive, VoicelessVelarPlosive, VoicedVelarPlosive,
            ...
            AlveolarLateralApproximant, PalatalApproximant, LabialPalatalApproximant,
            LabialVelarApproximant, VoicedUvularFricative,
        ...
        Language::English => &[
            ...
            OpenMidBackRounded, CloseBackRounded, Schwa,
            NearCloseFrontEn, NearCloseBackRoundedEn, OpenMidBackEn, NearOpenFrontEn,
            OpenBackRoundedEnGb, RColoredSchwaEnUs, OpenMidCentralEnGb, RColoredOpenMidCentralEnUs,
            ...
            VoicelessBilabialPlosive, VoicedBilabialPlosive, VoicelessAlveolarPlosive,
            VoicedAlveolarPlosive, VoicelessVelarPlosive, VoicedVelarPlosive,
            BilabialNasal, AlveolarNasal, VelarNasal,
            VoicelessLabiodentalFricative, VoicedLabiodentalFricative,
            VoicelessDentalFricative, VoicedDentalFricative,
            VoicelessAlveolarFricative, VoicedAlveolarFricative,
            VoicelessPostalveolarFricative, VoicedPostalveolarFricative,
            VoicelessPostalveolarAffricate, VoicedPostalveolarAffricate,
            VoicelessGlottalFricative, AlveolarLateralApproximant, AlveolarApproximant,
            PalatalApproximant, LabialVelarApproximant,
            SyllabicL, SyllabicN, SyllabicM, GlottalStop, VoicelessLabialVelarFricative,
            // Flap américain réutilise AlveolarTap (partagé avec l'espagnol).
            AlveolarTap,
        ],
        Language::Spanish => &[
            OpenCentral, CloseFront, CloseMidFront, CloseMidBackRounded, CloseBackRounded,
            VoicelessBilabialPlosive, VoicedBilabialPlosive, VoicedBilabialApproximant,
            ...
            AlveolarLateralApproximant, PalatalApproximant, LabialVelarApproximant,
            AlveolarTap, AlveolarTrill,
        ],
    }
}
